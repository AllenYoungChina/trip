    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sight', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tickets', to='sight.Sight', verbose_name='景点')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sight', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='sight.Sight', verbose_name='景点')),
            ],
            options={
                'db_table': 'sight_info',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='accounts.User', verbose_name='评论用户')),
            ],
            options={
