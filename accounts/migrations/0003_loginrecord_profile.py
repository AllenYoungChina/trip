# Generated by Django 3.0 on 2021-04-13 03:20
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('accounts', '0002_auto_20210412_1600'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.CharField(blank=True, max_length=128, null=True, verbose_name='邮箱地址')),
                ...
                ('is_phone_valid', models.BooleanField(default=False, verbose_name='手机号是否已验证')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='login_records', to=settings.AUTH_USER_MODEL, verbose_name='关联用户')),
            ],
            options={
